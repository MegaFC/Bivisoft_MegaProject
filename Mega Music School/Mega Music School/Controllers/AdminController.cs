...
namespace Mega_Music_School.Controllers
{
    public class AdminController : Controller
    {
        ...
        public IActionResult NationalityCreate(Country countryData)
        {
            ...
            {
                countryData.Message = "Add your department name to continue";
            ...
            else
            {
                ...
                if (countryCheck == null)
                {
                    ...
                    countryData.Message = " New department saved succesfully";
        ...
        public IActionResult StateCreate(State stateData)
        {
            ...
            {
                stateData.Message = "Add your department name to continue";
            ...
            else
            {
                ...
                if (stateCheck == null)
                {
                    ...
                    stateData.Message = " New department saved succesfully";
        ...
        public IActionResult LgaCreate(LGA lgaData)
        {
            ...
            else
            {
                ...
                if (lgaCheck == null)
                {
                    ...
                    lgaData.Message = " New department saved succesfully";
        ...
        [HttpPost]
        public IActionResult AcceptVideos(Guid videoId)
        {
